...
class RecordingController{
    ...
    recordCurrentUrl (href) {
        ...
        this.handleMessage({ selector: undefined, value: undefined, action: actions.GOTO, href })
    }
    
    recordCurrentViewportSize (value) {
        this.handleMessage({ selector: undefined, value, action: actions.VIEWPORT })
    }
    
    recordNavigation () {
        this.handleMessage({ selector: undefined, value: undefined, action: actions.NAVIGATION })
    }
