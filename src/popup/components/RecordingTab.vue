  ...
  <div class="tab recording-tab">
    <div class="content">
      <div class="empty" v-show="!isRecording">
        <img src="/images/monkeyface.png" alt="desert" width="78px">
        ...
        <ul class="event-list">
          <li v-for="(event, index) in liveEvents" :key="index" class="event-list-item">
            ...
            <div class="event-description">
              ...
              <div class="event-props text-muted">{{event.coordinates}}</div>
              <div class="event-props text-muted">{{event.offset}}</div>
            </div>
          </li>
        </ul>
      </div>
